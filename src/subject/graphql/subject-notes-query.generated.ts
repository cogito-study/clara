...
export type NoteQuery = { readonly __typename?: 'Query' } & {
...
export function useNoteQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<NoteQuery, NoteQueryVariables>,
) {
  return ApolloReactHooks.useQuery<NoteQuery, NoteQueryVariables>(NoteDocument, baseOptions);
}
export function useNoteLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<NoteQuery, NoteQueryVariables>,
) {
